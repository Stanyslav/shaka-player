...
goog.addDependency('../../../lib/hls/hls_parser.js', ['shaka.hls.HlsParser'], ['goog.Uri', 'goog.asserts', 'shaka.hls.ManifestTextParser', 'shaka.hls.Playlist', 'shaka.hls.PlaylistType', 'shaka.hls.Tag', 'shaka.hls.Utils', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.media.InitSegmentReference', 'shaka.media.ManifestParser', 'shaka.media.PresentationTimeline', 'shaka.media.SegmentIndex', 'shaka.media.SegmentReference', 'shaka.net.DataUriPlugin', 'shaka.net.NetworkingEngine', 'shaka.text.TextEngine', 'shaka.util.ArrayUtils', 'shaka.util.DataViewReader', 'shaka.util.Error', 'shaka.util.Functional', 'shaka.util.LanguageUtils', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.Mp4Parser', 'shaka.util.OperationManager']);
...
goog.addDependency('../../../lib/media/playhead.js', ['shaka.media.Playhead'], ['goog.asserts', 'shaka.log', 'shaka.media.GapJumpingController', 'shaka.media.TimeRangesUtils', 'shaka.media.VideoWrapper', 'shaka.util.IDestroyable', 'shaka.util.Timer']);
goog.addDependency('../../../lib/media/playhead_observer.js', ['shaka.media.MediaSourcePlayheadObserver', 'shaka.media.PlayheadObserver', 'shaka.media.VideoPlayheadObserver'], ['goog.asserts', 'shaka.media.TimeRangesUtils', 'shaka.util.Destroyer', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.IDestroyable', 'shaka.util.ObjectUtils', 'shaka.util.StreamUtils']);
...
goog.addDependency('../../../lib/net/http_fetch_plugin.js', ['shaka.net.HttpFetchPlugin'], ['goog.asserts', 'shaka.net.HttpPluginUtils', 'shaka.net.NetworkingEngine', 'shaka.util.AbortableOperation', 'shaka.util.Error', 'shaka.util.MapUtils']);
...
goog.addDependency('../../../lib/net/networking_engine.js', ['shaka.net.NetworkingEngine'], ['goog.Uri', 'goog.asserts', 'shaka.log', 'shaka.net.Backoff', 'shaka.util.AbortableOperation', 'shaka.util.Error', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.IDestroyable', 'shaka.util.ObjectUtils', 'shaka.util.OperationManager']);
goog.addDependency('../../../lib/offline/download_manager.js', ['shaka.offline.DownloadManager'], ['shaka.net.NetworkingEngine', 'shaka.util.Error', 'shaka.util.IDestroyable']);
...
goog.addDependency('../../../lib/offline/offline_manifest_parser.js', ['shaka.offline.OfflineManifestParser'], ['goog.asserts', 'shaka.log', 'shaka.media.ManifestParser', 'shaka.offline.ManifestConverter', 'shaka.offline.OfflineUri', 'shaka.offline.StorageMuxer', 'shaka.util.Destroyer', 'shaka.util.Error']);
goog.addDependency('../../../lib/offline/offline_scheme.js', ['shaka.offline.OfflineScheme'], ['goog.asserts', 'shaka.net.NetworkingEngine', 'shaka.offline.OfflineUri', 'shaka.offline.StorageMuxer', 'shaka.util.AbortableOperation', 'shaka.util.Destroyer', 'shaka.util.Error']);
...
goog.addDependency('../../../lib/offline/storage.js', ['shaka.offline.Storage'], ['goog.asserts', 'shaka.Player', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.media.ManifestParser', 'shaka.net.NetworkingEngine', 'shaka.offline.DownloadManager', 'shaka.offline.OfflineUri', 'shaka.offline.SessionDeleter', 'shaka.offline.StorageCellPath', 'shaka.offline.StorageMuxer', 'shaka.offline.StoredContentUtils', 'shaka.offline.StreamBandwidthEstimator', 'shaka.util.ArrayUtils', 'shaka.util.Destroyer', 'shaka.util.Error', 'shaka.util.IDestroyable', 'shaka.util.ManifestFilter', 'shaka.util.PlayerConfiguration', 'shaka.util.StreamUtils']);
...
goog.addDependency('../../../lib/player.js', ['shaka.Player'], ['goog.asserts', 'shaka.log', 'shaka.media.ActiveStreamMap', 'shaka.media.AdaptationSetCriteria', 'shaka.media.DrmEngine', 'shaka.media.ManifestParser', 'shaka.media.MediaSourceEngine', 'shaka.media.MediaSourcePlayheadObserver', 'shaka.media.Playhead', 'shaka.media.PlayheadObserver', 'shaka.media.PreferenceBasedCriteria', 'shaka.media.SegmentReference', 'shaka.media.StreamingEngine', 'shaka.net.NetworkingEngine', 'shaka.text.SimpleTextDisplayer', 'shaka.util.ArrayUtils', 'shaka.util.Destroyer', 'shaka.util.Error', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.IDestroyable', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.MultiMap', 'shaka.util.ObjectUtils', 'shaka.util.PlayerConfiguration', 'shaka.util.PublicPromise', 'shaka.util.StreamUtils']);
...
goog.addDependency('../../../lib/text/text_engine.js', ['shaka.text.TextEngine'], ['goog.asserts', 'shaka.util.Error', 'shaka.util.IDestroyable', 'shaka.util.MimeUtils']);
...
goog.addDependency('../../../lib/util/destroyer.js', ['shaka.util.Destroyer'], ['shaka.util.IDestroyable', 'shaka.util.PublicPromise']);
...
goog.addDependency('../../../ui/controls.js', ['shaka.ui.Controls'], ['goog.asserts', 'mozilla.LanguageMapping', 'shaka.ui.Locales', 'shaka.ui.Localization', 'shaka.ui.Utils', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.Timer']);
goog.addDependency('../../../ui/locales.js', ['shaka.ui.Locales', 'shaka.ui.Locales.Ids'], ['shaka.ui.Localization']);
...
goog.addDependency('../../../ui/ui.js', ['shaka.ui.Overlay'], ['goog.asserts', 'shaka.polyfill.installAll', 'shaka.ui.Controls']);
