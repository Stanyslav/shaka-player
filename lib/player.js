...
shaka.Player.prototype.selectTextTrack = function(track) {
  ...
  const stream = StreamUtils.findTextStreamForTrack(period, track);
...
shaka.Player.prototype.selectEmbeddedTextTrack = function() {
  shaka.log.alwaysWarn('This method is deprecated and will be removed in ' +
      'v2.6. If closed captions are signaled in the manifest, a text stream ' +
      'will be created to representthem.');
...
shaka.Player.prototype.usingEmbeddedTextTrack = function() {
  shaka.log.alwaysWarn('This method is deprecated and will be removed in ' +
      ...
      'will be created to representthem.');
  const activeText =
      this.streamingEngine_ ? this.streamingEngine_.getActiveText() : null;
...
/**
 * Returns current program time as a Date.
 *
 * @return {Date}
 * @export
 */
shaka.Player.prototype.getProgramDateTime = function() {
    if (!this.manifest_) return null;
    return this.manifest_.presentationTimeline.getProgramDateTime();
};
