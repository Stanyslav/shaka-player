...
shaka.media.PresentationTimeline
    .prototype.setProgramDateTime = function(time) {
    shaka.log.info('PresentationTimeline:',
        'setProgramDateTime=' + time);
    this.programDateTime_ = time;
};
